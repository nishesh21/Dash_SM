...
import { SevenMentorLogo } from "components/icons/Icons";
  ...
  let brand = (
    <Link
      ...
      <Stack direction='row' spacing='12px' align='center' justify='center'>
        <SevenMentorLogo h='26px' w='175px' color={logoColor} />
      </Stack>
  ...
  if (props.secondary === true) {
    brand = (
      <Link
        ...
        alignItems='center'
        color={mainText}>
        <SevenMentorLogo h='26px' w='175px' my='32px' color={logoColor} />
      </Link>
    );
    ...
    <SidebarContext.Provider value={{ sidebarWidth }}>
      <Flex
        ...
        <Flex w='100%' justifyContent={{ sm: "start", lg: "space-between" }}>
          ...
          {linksAuth}
          <Link href='https://www.SevenMentor-ui.com/pro'>
            <Button
              bg={bgButton}
              color={colorButton}
              fontSize='xs'
